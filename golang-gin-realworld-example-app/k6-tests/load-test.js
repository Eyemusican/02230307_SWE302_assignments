...
export const options = {
    ...
    thresholds: {
        ...
        // Note: http_req_failed includes expected 422 validation errors (duplicate users)
        // http_reqs rate adjusted for SQLite limitations (production DB would be higher)
    },
};
